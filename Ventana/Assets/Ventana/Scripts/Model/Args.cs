...
public class Args : MonoBehaviour {
    public static string HOLOHUB_IP = "192.168.0.115";
    public static string PREFAB_LOCATION = "Ventana/Prefabs/"; //in Resources Folder
    public static string HOLOHUB_ADDRESS = "http://192.168.0.115:8081";
    public static string HOLOHUB_WEBSOCKET_ADDRESS = "ws://192.168.0.115:4200/socket.io/?EIO=3&transport=websocket";
