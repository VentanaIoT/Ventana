...
public class Args {
    ...
    public static string HOLOHUB_ADDRESS = "http://192.168.0.113:8081";
    public static string HOLOHUB_WEBSOCKET_ADDRESS = "ws://192.168.0.113:4200/socket.io/?EIO=3&transport=websocket";
